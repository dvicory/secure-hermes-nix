# task-workspace-handoffs Specification

## Purpose
Define the broker's task-run authorization, fenced immutable output capture, two-phase structural validation, replay recovery, selected-artifact reads, and gated local-control boundary for task workspace handoffs.
## Requirements
