...
- [x] 5.6 Run focused Kanban, Hermes, broker, Nix module, and end-to-end checks for the complete immutable input lifecycle (`hermes-worker-lane`: 875 passed; `gondolin-broker-effect`: 90 passed; secure-terminal socket and policy HTTP checks passed).
