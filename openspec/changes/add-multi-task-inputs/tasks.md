...
- [ ] 5.3 Verify destination retry, edge mutation, stale runs, response-loss replay, changed-fact conflicts, and preservation of existing pins under a synthetic newer-completion fixture.
