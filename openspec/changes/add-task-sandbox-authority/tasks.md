...
- [x] 5.3 Deploy only the QA `hvn-hyp1` profile, run the Hermes-agent prompt/scenario against default, dynamically approved public/private, revoked, and denied paths, record observed compatibility without production changes, and commit the verified final configuration.
