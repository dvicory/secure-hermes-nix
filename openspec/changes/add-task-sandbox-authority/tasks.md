...
- [ ] 1.1 Complete and commit the `hvn-hyp1` QA broker's policy-backed Gondolin HTTP/DNS enforcement, including exact public origins, internal-range denial, worklane attenuation fixtures, and the targeted broker/Nix rebuild checks.
